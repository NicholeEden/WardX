...
namespace EFCore
{
    // this context class represents the database structure and its tables
    public class DatabaseContext : DbContext
    {
        // we are overriding the virtual method 'OnConfiguring()' from DbContext in order to set a custom
        // connection string for our database
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer(@"Data Source = (LocalDB)\MSSQLLocalDB; Integrated security = True; Database = HWMS06DB");
        }
