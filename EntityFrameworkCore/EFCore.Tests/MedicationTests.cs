...
namespace EFCore.Tests
{
    public class MedicationTests
    {
        ...
        public MedicationTests(ITestOutputHelper output)
        {
            this.output = output;
        ...
        [Theory]
        [InlineData(nameof(Medication.MedicationName))]
        [InlineData(nameof(Medication.MedicationStrength))]
        public void Data_Annotation_Required(string nullableColumn)
        {
            // Arrange - Create a null instance
            var domainModel = new Medication();
        ...
        [Theory]
        [InlineData(nameof(IMedication.MedicationName), 1024)]
        [InlineData(nameof(IMedication.MedicationStrength), 1024)]
        public void Data_Annotation_MaxLength(string column, int maxLength)
        {
            ...
            var domainModel = new Medication()
            {
                MedicationName = fluff,
                MedicationStrength = fluff
            };
        ...
        public void Data_Annotation_Valid()
        {
            ...
            var domainModel = context.Medication.ToList();
