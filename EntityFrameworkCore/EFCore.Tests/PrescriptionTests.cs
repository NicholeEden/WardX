...
namespace EFCore.Tests
{
    public class PrescriptionTests
    {
        ...
        public PrescriptionTests(ITestOutputHelper output)
        {
            this.output = output;
        }

        [Theory]
        [InlineData(nameof(IPrescription.Instruction))]
        public void Data_Annotation_Required(string nullableColumn)
        {
            // Arrange - Create a null instance
            var domainModel = new Prescription();
        ...
        [Theory]
        [InlineData(nameof(IPrescription.Instruction), 1024)]
        ...
        public void Data_Annotation_Valid()
        {
            ...
            var domainModel = new Prescription
            {
                Instruction = "These are some pretty awesome notes"
            };
        ...
        [Theory]
        [InlineData("ClassName.PropertyName")]
