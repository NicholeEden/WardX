...
namespace EFCore.Tests
{
    public class EmergencyContactTests
    {
        ...
        public EmergencyContactTests(ITestOutputHelper output)
        {
            this.output = output;
        }

        [Theory]
        [InlineData(nameof(IEmergencyContact.AddressLine1))]
        [InlineData(nameof(IEmergencyContact.EmailAddress))]
        [InlineData(nameof(IEmergencyContact.FirstName))]
        [InlineData(nameof(IEmergencyContact.LastName))]
        [InlineData(nameof(IEmergencyContact.MobileNumber))]
        [InlineData(nameof(IEmergencyContact.Relationship))]
        ...
        [Theory]
        [InlineData(nameof(IEmergencyContact.AddressLine1), 1024)]
        [InlineData(nameof(IEmergencyContact.EmailAddress), 1024)]
        [InlineData(nameof(IEmergencyContact.FirstName), 1024)]
        [InlineData(nameof(IEmergencyContact.LastName), 1024)]
        [InlineData(nameof(IEmergencyContact.MobileNumber), 10)]
        [InlineData(nameof(IEmergencyContact.Relationship), 128)]
        ...
        [Theory]
        [InlineData(nameof(EmergencyContact.Patient))]
        [InlineData(nameof(EmergencyContact.Suburb))]
