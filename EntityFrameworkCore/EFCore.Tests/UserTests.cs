...
namespace EFCore.Tests
{
    public class UserTests
    {
        ...
        [Theory]
        [InlineData(nameof(IUser.PasswordHash))]
        [InlineData(nameof(IUser.UserName))]
        ...
        [Theory]
        [InlineData(nameof(IUser.PasswordHash), 1024)]
        [InlineData(nameof(IUser.UserName), 128)]
        ...
        [Theory]
        [InlineData(nameof(User.UserRoles))]
        [InlineData(nameof(User.StaffMember))]
