...
namespace EFCore.Tests
{
    ...
    //    public EpauletteTests(ITestOutputHelper output)
    //    {
    //        this.output = output;
    ...
    //    [Fact]
    //    public void Epaulette_Has_Data_Seeded()
    //    {
    //        // Arrange [declare expected values]
    //        int expected = 7;

    //        // Act [calculate actual values]
    //        int actual = context.Epaulette.Count();

    //        // Assert [compare actual value with expected value]
    //        output.WriteLine($"There should be at least { expected } row(s) of data in the { nameof(context.Epaulette) } table");
    //        Assert.True(actual >= expected);
    //    }

    //    [Theory]
    //    [InlineData(nameof(IEpaulette.Colour))]
    //    [InlineData(nameof(IEpaulette.Description))]
    //    public void Data_Annotation_Required(string nullableColumn)
    //    {
    //        // Arrange - Create a null instance
    //        var domainModel = new Epaulette();
    ...
    //    [Theory]
    //    [InlineData(nameof(IEpaulette.Colour), 1024)]
    //    [InlineData(nameof(IEpaulette.Description), 1024)]
    ...
    //        var domainModel = context.Epaulette.ToList();
