...
namespace EFCore.Tests
{
    public class TreatmentTypeTests
    {
        ...
        public TreatmentTypeTests(ITestOutputHelper output)
        {
            this.output = output;
        ...
        [Fact]
        public void TreatmentType_Has_Data_Seeded()
        {
        ...
        [Theory]
        [InlineData(nameof(ITreatmentType.Description), 1024)]
        ...
        public void Data_Annotation_Valid()
        {
            ...
            var domainModel = context.TreatmentType.ToList();
