...
namespace DataAccess.Tests
{
    public class MedicalAidPlanTests
    {
        ...
        [Fact]
        public void GetAll_MedicalAidPlan()
        {
            using (var mock = AutoMock.GetLoose())
            {
                // the stored procedure expected
                var sql = _StoredProcedureProvider.sp_SelectMedicalAidPlan.ToString();
